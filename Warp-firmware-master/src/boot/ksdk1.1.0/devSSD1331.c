...
//Three sub-pixels for color A, B and C have 6 bits, 5 bits and 6 bits respectively
	...
	writeCommand(0x72);				// RGB 65K format1 Color 0b01110010
	...
	writeCommand(0x31);//0b00100001
	writeCommand(kSSD1331CommandCLOCKDIV);		// 0xB3
	writeCommand(0xF0);		//see page 46	// 7:4 = Oscillator Frequency (configured highest), 3:0 = CLK Div Ratio (A[3:0]+1 = 1..16)
	writeCommand(kSSD1331CommandPRECHARGEA);	// 0x8A
	writeCommand(0x64);
	writeCommand(kSSD1331CommandPRECHARGEB);	// 0x8B
	writeCommand(0x78);				// highest second pre-charge speed
	...
	writeCommand(0x0F); //16/16 attenuation
	...
	writeCommand(0xB9);				//Reset built in gray scale table (Linear)
